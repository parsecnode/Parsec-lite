...
public:
    ...
    void retranslateUi(QFrame *ConnectionOptionsFrame)
    {
        ...
        m_autoHelperLabel->setText(QApplication::translate("ConnectionOptionsFrame", "Wallet will connect to local Parsec daemon process on default port 32616. In case of no local daemon running it will use a random remote node.", nullptr));
        ...
        m_localHelperLabel->setText(QApplication::translate("ConnectionOptionsFrame", "Wallet will connect to local Parsec daemon process. Please specify daemon's port.", nullptr));
        ...
        m_remoteHelperLabel->setText(QApplication::translate("ConnectionOptionsFrame", "Wallet will connect to Parsec node running on another PC in the local or global network. Please specify IP address or domain name and the port.", nullptr));
        label_4->setText(QApplication::translate("ConnectionOptionsFrame", "Wallet may send small fee from each transaction to the remote node it is connected to, but no more than 1 PARS.", nullptr));
    } // retranslateUi
