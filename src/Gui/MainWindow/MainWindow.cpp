...
const char COMMUNITY_FORUM_URL[] = "https://forum.parsecnode.com";
const char REPORT_ISSUE_URL[] = "https://parsecnode.com/contact";

const char DONATION_URL_DONATION_TAG[] = "donation";
const char DONATION_URL_LABEL_TAG[] = "label";
const char DONATION_ADDRESS[] = "PARSkAmcBG8ZWqgfCu65fddB1yxzbTpGF6wzyLBsTUmoJUd1WmB8Bgj9h9LGbmVQEEEYAFHVJCWCVBEeEfsbK5ay6tSDmDup7i";
...
MainWindow::MainWindow(ICryptoNoteAdapter* _cryptoNoteAdapter, IAddressBookManager* _addressBookManager,
  ...
  m_ui->setupUi(this);
  setWindowTitle(tr("Parsec Lite %1").arg(Settings::instance().getVersion()));
