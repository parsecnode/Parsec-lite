...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        QIcon icon;
        icon.addFile(QStringLiteral(":/images/parsec"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        m_aboutparsecAction = new QAction(MainWindow);
        m_aboutparsecAction->setObjectName(QStringLiteral("m_aboutparsecAction"));
        m_aboutparsecAction->setEnabled(true);
        ...
        menuHelp->addAction(m_aboutparsecAction);
        ...
        QObject::connect(m_aboutparsecAction, SIGNAL(triggered()), MainWindow, SLOT(about()));
...
#endif // QT_NO_TOOLTIP
        m_aboutparsecAction->setText(QApplication::translate("MainWindow", "About Parsec Lite Wallet", nullptr));
